...
namespace Bno1
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    Symbol = Symbol.Home,
                    Label = "Home",
                    DestinationPage = typeof(Views.StartPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Accept,
                    Label = "Todo",
                    DestinationPage = typeof(Views.SingleAdvicePage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Favorite,
                    Label = "Ticket",
                    DestinationPage = typeof(Views.TicketPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Find,
        ...
        {
            if (this.AppFrame.CurrentSourcePageType != typeof(WelcomePage))
            {
                this.AppFrame.Navigate(typeof(WelcomePage), null);
            }
        }
